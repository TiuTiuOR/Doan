<?php 
    ...
    **/
    ...
    $nFrom = 'Tiêu Quang Trường';
    $mFrom = 'tieuquangtruong270502@gmail.com';  //dia chi email cua ban 
    $mPass = 'scet xmbz ktld purn';       //mat khau email cua ban
    $mail             = new PHPMailer();
    $body             = $content;
    $mail->IsSMTP(); 
    $mail->CharSet   = "utf-8";
    ...
    $mail->AddReplyTo('tieuquangtruong270502@gmail.com', 'Tiêu Quang Trường');
